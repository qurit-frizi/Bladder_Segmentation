...
from unet_code.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, create_decoders
...
class SemanticSegNet(nn.Module):
    ...
    def __init__(self, cfg, device):
        super().__init__()
        self.backbone = UNet3D(**cfg['MODEL']['UNET'])
        self.device = device
...
def build_model(cfg, device):
    model = SemanticSegNet(cfg, device)
